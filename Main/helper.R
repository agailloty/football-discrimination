all_columns <- c("sofifa_id", "player_url", "short_name", "long_name", "age", 
                     ...
                     "lb", "lcb", "cb", "rcb", "rb", "league_nationality")

columns_to_keep <- c("short_name", "age", 
                        "height_cm", "weight_kg", "nationality", "club_name", "league_rank", "overall", "potential", "value_eur", 
                        "wage_eur",  "international_reputation", 
                        "weak_foot", "skill_moves", "work_rate",
                        "release_clause_eur",  "joined", "contract_valid_until",
                        "league_nationality", "foreigner")

columns_for_pca <- c( "short_name",
                     "attacking_crossing", "attacking_finishing", "attacking_heading_accuracy", 
                     "attacking_short_passing", "attacking_volleys", "skill_dribbling", 
                     "skill_curve", "skill_fk_accuracy", "skill_long_passing", "skill_ball_control", 
                     "movement_acceleration", "movement_sprint_speed", "movement_agility", 
